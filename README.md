...
For this board we only need to attach a LEDstrip. Attaching the strip should be easy. Attach the yellow cable to D1, the red one to 3V and the black one on G.
